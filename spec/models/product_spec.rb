...
describe Product do
  ...
  describe ".above_or_equal_to_price" do
  	...
  	it "returns the products that are above or equal to the price" do
  ...
  describe ".below_or_equal_to_price" do
  	...
  	it "returns the products that are below or equal to the price" do
  ...
  describe ".search" do
  	...
  	context "when title 'videogame' and a 100 min_price are set" do
  	...
  	context "when title 'tv', 150 as max_price, and 50 as min_price are set" do
